...
public class SharesOutputHelperWrapperTests
{
    ...
    public void CreateSharesOutput_ReturnsSharesOutput_GivenSharesInputAndFlattenStock()
    {
        ...
        Assert.Equal(279.51, orderedResults[0].AdjustedClose);
        ...
        Assert.Equal(520.65, orderedResults[1].AdjustedClose);
        ...
        Assert.Equal(520.65, orderedResults[2].AdjustedClose);
        ...
        Assert.Equal(520.65, orderedResults[3].AdjustedClose);
        ...
        Assert.Equal(520.65, orderedResults[4].AdjustedClose);
        ...
        Assert.Equal(189.53, orderedResults[5].AdjustedClose);
        ...
        Assert.Equal(189.53, orderedResults[6].AdjustedClose);
